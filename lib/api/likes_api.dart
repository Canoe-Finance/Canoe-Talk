...
class LikesApi {
    ...
    _firestore
      ...
      if (snapshot.docs.isEmpty) {
        ...
        await _saveLike(
            ...
            nMessage: nMessage,
            notifyUserId: likedUserId);
        logger.info('likeUser() -> success');
      } else {
        onLikeResult(false);
        logger.info('You already liked the user');
      }
    }).catchError((e) {
      logger.info('likeUser() -> error: $e');
    });
  }
  ...
  Future<List<DocumentSnapshot<Map<String, dynamic>>>> getLikedMeUsers(
    ...
    final QuerySnapshot<Map<String, dynamic>> querySnapshot =
        await usersQuery.get().catchError((e, s) {
      logger.info('getLikedMeUsers() -> error: $e $s');
    });
  ...
  Future<void> deleteLike(String likedUserId) async {
    _firestore
      ...
      logger.info('deleteLike() -> error: $e');
    });
  }
  ...
  Future<void> deleteLikedUsers() async {
    _firestore
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        logger.info('deleteLikedUsers() -> deleted');
      }
    });
  }
  ...
  Future<void> deleteLikedMeUsers() async {
    _firestore
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        logger.info('deleteLikedMeUsers() -> deleted');
      }
    });
  }
}
