...
import 'package:canoe_dating/plugins/video_call/widgets/call_timer.dart';
import 'package:canoe_dating/plugins/video_call/widgets/raw_button.dart';
  ...
  Widget _renderRemoteVideo(AppLocalizations i18n) {
    if (remoteUserId != null) {
      return RtcRemoteView.SurfaceView(
          uid: remoteUserId!, channelId: callInfo.callID);
    } else {
      return Text(
        callInfo.isCaller
            ? '${i18n.translate("calling")}\n${callInfo.userProfileName}\n${i18n.translate("please_wait")}'
            : i18n
                .translate('please_wait_profile_name_to_join')
                .replaceFirst('profile_name', callInfo.userProfileName),
