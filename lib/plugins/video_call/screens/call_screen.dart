...
import 'package:canoe_dating/plugins/video_call/widgets/video_call.dart';
import 'package:canoe_dating/plugins/video_call/widgets/voice_call.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _stopRingtone() async {
    ...
    if (widget.callInfo.isCaller) {
      ...
      logger.info('Ringtone stopped!');
    }
  }

  Future<void> _initializeAgoraSettings() async {
    // logger.info('agoraAppID is $agoraAppID');
    // Check Agora APP ID
  ...
  void _addAgoraEventHandlers() {
    _engine.setEventHandler(RtcEngineEventHandler(
      error: (code) {
        // Error callback
        logger.warning('onError: $code');
      },
      joinChannelSuccess: (String channel, int uid, int elapsed) {
        // On Join Channel Success callback
        logger.info('onJoinChannel: $channel, uid: $uid');
      },
