...
import 'package:canoe_dating/plugins/stories/constants/constants.dart';
...
class StoriesApi {
  ...
  Stream<List<DocumentSnapshot<Object?>>> getStoryProfiles() {
    // Build query
  ...
  Future<void> deleteAllStories() async {
    ...
    if (queryStories.docs.isNotEmpty) {
      // Init process
      logger.info('deleteAllStories() -> processing...');
