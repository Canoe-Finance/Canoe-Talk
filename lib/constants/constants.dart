...
///
const String APP_NAME = 'Canoe TALK';
const Color APP_PRIMARY_COLOR = Color(0xFFDD88CF);
// const Color APP_PRIMARY_COLOR = Colors.pink;
// const Color APP_ACCENT_COLOR = Colors.pinkAccent;
const Color APP_ACCENT_COLOR = Color(0xFF4B164C);
...
//
// const String ANDROID_MAPS_API_KEY = '';
// const String IOS_MAPS_API_KEY = '';
//
...
const String SENTRY_DSN = '/*your sentry dsn*/';
...
const String C_NFT_AIRDROPS = 'NFTAirdrops';
...
const String ANDROID_RELEASE_LINK = 'android_release_link';
...
const String USER_WALLET_ADDRESS = 'user_wallet_address';
const String USER_NFT_PORTRAIT = 'user_nft_portrait';
const String USER_NFT_NAME = 'user_nft_name';
...
const String IS_AUDIO_ENABLED = 'is_audio_enabled';
...
const String MESSAGE_EXTRA = 'message_extra';
const String MESSAGE_READ = 'message_read';
const String LAST_MESSAGE = 'last_message';

enum MessageType { text, greeting, image, match }
