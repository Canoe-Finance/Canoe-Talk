...
class User {
  ...
  factory User.fromDocument(Map<String, dynamic> doc) {
    return User(
      walletAddress: doc[USER_WALLET_ADDRESS],
      nftPortrait: doc[USER_NFT_PORTRAIT],
      nftName: doc[USER_NFT_NAME],
      userId: doc[USER_ID],
      ...
      // Custom variables
      isAudioEnabled: doc['is_audio_enabled'] ?? false,
    );
  }
}
