...
class _DeleteAccountScreenState extends State<DeleteAccountScreen> {
  ...
  Future<void> _deleteUserAccount() async {
    ...
    logger.info('Profile account -> deleted...');
    ...
    logger.info('Profile images -> deleted...');
