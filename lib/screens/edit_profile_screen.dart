...
import 'package:canoe_dating/widgets/user_gallery.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    useLogger('<[EditProfileScreen]>', props: {});
            ...
            child: ScopedModelDescendant<UserModel>(
              ...
              return Column(
                ...
                children: [
                  ...
                  Column(children: [
                    Center(
                      child: UserModel().user.nftPortrait?.isNotEmpty == true
                          ? Stack(children: <Widget>[
                              Container(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: UserModel().user.nftPortrait!,
                                ),
                              ),
                  ...
                  /// Show gallery
                  UserGallery(updateProfileImage: _selectImage),
  ...
  Widget updateNftButton() {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 32),
      padding: const EdgeInsets.symmetric(vertical: 2),
      decoration: BoxDecoration(
        color: const Color(0xFFc9b699),
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        TextButton(
          onPressed: () => Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const SelectNFTsScreen()),
          ),
          child: const Text(
            'NFT avatar',
